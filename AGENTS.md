...
- Auth: `FANSLY_TOKEN` (modo token, HTTP puro) o perfil Chromium persistente (modo browser). `401` → refrescar/continuar sesión; `400` → sin sesión válida
...
## Gotchas críticos
- Hay **13 herramientas** (no 12): actualizar conteos en docs/README.md al añadir/eliminar tools
